...
const teamData = [
  ...
  { name: 'Alexander Zhao', role: 'Consultant', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/alexander-zhao-/', year: 'Sophomore', description: 'Analyzing data to uncover actionable insights for clients.', interests: ['Data Mining', 'Visualization', 'Analytics'], workHistory: ['DataStory Consultant', 'Data Analyst'] },
  { name: 'Anthony Kobzar', role: 'Consultant', major: 'Data Science, Economics', linkedin: 'https://www.linkedin.com/in/anthony-kobzar-182889252/', year: 'Sophomore', description: 'Combining data science with economic analysis for comprehensive solutions.', interests: ['Econometrics', 'Financial Analysis', 'Modeling'], workHistory: ['DataStory Consultant', 'Finance Intern'] },
  ...
  { name: 'Diya Pendyala', role: 'Consultant', major: 'Data Science', linkedin: '', year: 'Sophomore', description: 'Working on data analysis and visualization for client projects.', interests: ['Data Visualization', 'Storytelling', 'Analytics'], workHistory: ['DataStory Consultant'] },
  ...
  { name: 'Ria Voodi', role: 'Consultant', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/riavoodi/', year: 'Sophomore', description: 'Supporting data analysis and insights generation for projects.', interests: ['Data Science', 'Healthcare Analytics', 'Research'], workHistory: ['DataStory Consultant', 'Health Research'] },
  { name: 'Akshay Anand', role: 'Consultant', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/akshay-anand-968b27230/', year: 'Sophomore', description: 'Building data pipelines and analytical models for clients.', interests: ['Data Engineering', 'Big Data', 'Python'], workHistory: ['DataStory Consultant', 'Data Engineer Intern'] },
  { name: 'Dennis Vengerov', role: 'Consultant', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/dennis-vengerov-a78376294/', year: 'Sophomore', description: 'Applying analytical skills to deliver insights for client projects.', interests: ['Machine Learning', 'Sports Analytics', 'Statistics'], workHistory: ['DataStory Consultant', 'Sports Data Analyst'] },
  // Senior Advisors
  { name: 'Piya Shah', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/piya-shahh/', year: 'Senior', description: 'Providing guidance and mentorship to current DataStory members.', interests: ['Data Strategy', 'Mentorship', 'Analytics'], workHistory: ['DataStory Advisor', 'Former Executive', 'Data Scientist Intern'] },
  { name: 'Katelyn Jo', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/katelyn-jo/', year: 'Senior', description: 'Sharing experience and expertise to guide DataStory\'s growth.', interests: ['Product Analytics', 'Leadership', 'Career Development'], workHistory: ['DataStory Advisor', 'Product Analyst Intern'] },
  { name: 'Sara Miller', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/sara-jade-miller/', year: 'Senior', description: 'Mentoring members and advising on strategic initiatives.', interests: ['Business Analytics', 'Consulting', 'Data Science'], workHistory: ['DataStory Advisor', 'Consulting Analyst'] },
  { name: 'Hannah Chung', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/hannah-c-8714121b2/', year: 'Senior', description: 'Supporting the organization with industry insights and mentorship.', interests: ['Tech Industry', 'Data Analytics', 'Networking'], workHistory: ['DataStory Advisor', 'Tech Company Intern'] },
  { name: 'Simon Cha', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/simon-cha/', year: 'Senior', description: 'Providing strategic advice and connecting members with opportunities.', interests: ['Startups', 'Entrepreneurship', 'Data Products'], workHistory: ['DataStory Advisor', 'Startup Experience'] },
  ...
  { name: 'Ethan Wei', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/ethan-wei-b24345235/', year: 'Senior', description: 'Mentoring consultants and sharing technical expertise.', interests: ['Data Infrastructure', 'Engineering', 'Mentoring'], workHistory: ['DataStory Advisor', 'Data Engineer'] },
  { name: 'Pulak Dugar', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/pulak-dugar/', year: 'Senior', description: 'Advising on technical and strategic matters for DataStory.', interests: ['AI Research', 'Deep Learning', 'Strategy'], workHistory: ['DataStory Advisor', 'AI Research Intern'] },
  { name: 'Kayle Marsh', role: 'Advisor', major: 'Electrical Engineering and Computer Science', linkedin: 'http://www.linkedin.com/in/kaylemarsh', year: 'Senior', description: 'Bringing engineering expertise to advise DataStory projects.', interests: ['Systems Engineering', 'Hardware', 'Software'], workHistory: ['DataStory Advisor', 'Engineering Intern'] },
  { name: 'Divya Madgula', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/divya-madgula/', year: 'Senior', description: 'Supporting members with guidance and industry knowledge.', interests: ['Healthcare Data', 'Analytics', 'Research'], workHistory: ['DataStory Advisor', 'Healthcare Analytics'] },
  { name: 'Arav Sachdeva', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/aravs/', year: 'Senior', description: 'Mentoring members and advising on career development.', interests: ['Product Management', 'Data Science', 'Startups'], workHistory: ['DataStory Advisor', 'Product Intern'] },
  { name: 'Reid Trussler', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/reid-trussler-77a674264/', year: 'Senior', description: 'Providing insights from industry experience to guide members.', interests: ['Finance Analytics', 'Quantitative Research', 'Trading'], workHistory: ['DataStory Advisor', 'Quant Intern'] },
  { name: 'Avyuktha Mattupalli', role: 'Advisor', major: 'Data Science', linkedin: 'http://linkedin.com/in/avyuktha-mattupalli-9134a8249', year: 'Senior', description: 'Sharing experience and mentoring current DataStory members.', interests: ['Data Visualization', 'Storytelling', 'Education'], workHistory: ['DataStory Advisor', 'Data Analyst'] },
  ...
  { name: 'Ashika Thomas', role: 'Advisor', major: 'Data Science', linkedin: 'http://www.linkedin.com/in/ashikathomas', year: 'Senior', description: 'Supporting DataStory with mentorship and industry insights.', interests: ['NLP', 'Text Analytics', 'Research'], workHistory: ['DataStory Advisor', 'NLP Research'] },
  { name: 'Jack White', role: 'Advisor', major: 'Electrical Engineering and Computer Science', linkedin: 'https://www.linkedin.com/in/jack-white-568761272', year: 'Senior', description: 'Bringing technical engineering expertise to advise projects.', interests: ['Software Engineering', 'Systems', 'Architecture'], workHistory: ['DataStory Advisor', 'Software Engineer Intern'] },
  { name: 'Matthew Ho', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/matthewho88/', year: 'Senior', description: 'Mentoring members and advising on technical initiatives.', interests: ['Machine Learning', 'Computer Vision', 'Research'], workHistory: ['DataStory Advisor', 'ML Research Intern'] },
  { name: 'Neil Thomas', role: 'Advisor', major: 'Data Science, Electrical Engineering and Computer Science', linkedin: 'https://www.linkedin.com/in/neiltthomas', year: 'Senior', description: 'Interested in anything that provides me dopamine.', interests: ['Philosophy', 'Design', 'Photography'], workHistory: ['Figma', 'DeepLearning.AI', 'Visa', 'BAIR'] },
  { name: 'Rohan Gopalam', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/rohan-gopalam/', year: 'Senior', description: 'Providing guidance and support to DataStory members.', interests: ['Data Engineering', 'Cloud', 'Infrastructure'], workHistory: ['DataStory Advisor', 'Data Engineer Intern'] },
  { name: 'Peyton Schales', role: 'Advisor', major: 'Data Science', linkedin: 'https://www.linkedin.com/in/peytons224/', year: 'Senior', description: 'Sharing industry experience and mentoring consultants.', interests: ['Sports Analytics', 'Statistics', 'Modeling'], workHistory: ['DataStory Advisor', 'Sports Analyst'] },
]
